...
<body class="fix-header <?php if($panelInit->settingsArray['leftmenuScroller'] == "e"){ echo "fix-sidebar"; } ?> card-no-border" ng-app="ngGradeBook" ng-controller="mainController">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <?php if( $panelInit->settingsArray['languageAllow'] == "1" ){ ?>
                            <li class="nav-item dropdown" ng-hide="true">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer" <?php if($panelInit->settingsArray['leftmenuScroller'] != "e"){ ?> style='position:fixed !important;' <?php } ?>>
                <?php echo $panelInit->settingsArray['footer']; ?>
            </footer>
        </div>
    ...
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="{{URL::asset('assets/js/ngGradeBook.js')}}" type="text/javascript"></script>
